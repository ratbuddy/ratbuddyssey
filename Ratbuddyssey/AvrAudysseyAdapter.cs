...
namespace Ratbuddyssey
{
    ...
    class AvrAudysseyAdapter : INotifyPropertyChanged
    {
        ...
        #endregion
        public AvrAudysseyAdapter(bool bAttachSniffer = false)
        {
            AudioVideoReceiver = new AudioVideoReceiver(this, bAttachSniffer);
        }
        ~AvrAudysseyAdapter()
        {
